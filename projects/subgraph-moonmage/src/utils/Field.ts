...
export function loadField(account: Address): Field {
    ...
    if (field == null) {
        ...
        field.moonmage = MOONMAGE.toHexString()
        if (account !== MOONMAGE) { field.cosmomage = account.toHexString() }
        field.season = 1
        field.temperature = 1
        field.realRateOfReturn = ZERO_BD
        field.numberOfSowers = 0
        field.numberOfSows = 0
        field.sownMoons = ZERO_BI
        field.plotIndexes = []
...
export function loadFieldHourly(account: Address, season: i32, timestamp: BigInt): FieldHourlySnapshot {
    // Hourly for Moonmage is assumed to be by season. To keep other data correctly divided
    ...
    if (hourly == null) {
        ...
        hourly.deltaSownMoons = ZERO_BI
        hourly.sownMoons = field.sownMoons
...
export function loadFieldDaily(account: Address, timestamp: BigInt): FieldDailySnapshot {
    ...
    if (daily == null) {
        ...
        daily.deltaSownMoons = ZERO_BI
        daily.sownMoons = field.sownMoons
