...
export function createPodListingFilledEvent_v2(from: string, to: string, index: BigInt, start: BigInt, amount: BigInt, costInMoons: BigInt): void { }
...
export function createPodOrderFilledEvent_v2(from: string, to: string, id: Bytes, index: BigInt, start: BigInt, amount: BigInt, costInMoons: BigInt): void { }
