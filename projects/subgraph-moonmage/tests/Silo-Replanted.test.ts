...
import { MOON_ERC20 } from "../src/utils/Constants";
...
describe("Mocked Events", () => {
    ...
    describe("Moon", () => {
        test("AddDeposit - Silo and Assets updated", () => {
            ...
            let token = MOON_ERC20.toHexString().toLowerCase()
        ...
        test("RemoveDeposit - Cosmonaut Silo Amounts 50% Initial", () => {
        ...
        test("RemoveDeposit - Cosmonaut Silo Amounts 50% Remaining", () => {
