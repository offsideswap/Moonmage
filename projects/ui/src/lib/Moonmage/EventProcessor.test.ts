...
import { AddDepositEvent, AddWithdrawalEvent, PlotTransferEvent, RemoveDepositEvent, RemoveWithdrawalEvent, RemoveWithdrawalsEvent, SowEvent , HarvestEvent } from '~/generated/protocol/abi/Moonmage';

import { MOON, MOON_CRV3_LP, SILO_WHITELIST } from '~/constants/tokens';
...
describe('the Silo', () => {
  ...
  it('runs a simple deposit sequence (three deposits, two tokens, two seasons)', () => {
    const p = mockProcessor();
    const t1 = Moon.address.toLowerCase();
    const t2 = MoonCrv3.address.toLowerCase();
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        amount: EBN.from(1000 * 10 ** Moon.decimals), // Deposited 1,000 Moon
        bdv:    EBN.from(1000 * 10 ** Moon.decimals), 
      }),
    } as AddDepositEvent);
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(500 * 10 ** Moon.decimals), // Deposited 500 Moon
        bdv:    EBN.from(500 * 10 ** Moon.decimals), 
      }),
    } as AddDepositEvent);
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        amount: EBN.from(1000).mul(EBN.from(10).pow(MoonCrv3.decimals)), // Deposited 1,000 Moon:CRV3
        bdv:    EBN.from(900).mul(EBN.from(10).pow(Moon.decimals))
      }),
    } as AddDepositEvent);
  ...
  it('adds withdrawals', () => {
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(1000 * 10 ** Moon.decimals), // Withdrew 1,000 Moon
      }),
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(500 * 10 ** Moon.decimals), // Withdrew 500 Moon
      }),
    } as AddWithdrawalEvent);
  ...
  it('removes a single deposit, partial -> full', () => {
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(600 * 10 ** Moon.decimals),
        bdv:    EBN.from(600 * 10 ** Moon.decimals),
      })
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(400 * 10 ** Moon.decimals),
        bdv:    EBN.from(400 * 10 ** Moon.decimals),
      })
    } as RemoveDepositEvent);
  ...
  it('removes a single withdrawal', () => {
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(1000 * 10 ** Moon.decimals),
      }),
  ...
  it('removes multiple withdrawals, full', () => {
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6074),
        amount: EBN.from(1000 * 10 ** Moon.decimals), // Withdraw 1,000 Moon
      }),
    } as AddWithdrawalEvent);
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        season: EBN.from(6100),
        amount: EBN.from(5000 * 10 ** Moon.decimals), // Withdraw 1,000 Moon
      }),
    } as AddWithdrawalEvent);
    ...
    p.ingest({
      ...
      args: propArray({
        ...
        token:  t1,
        seasons: ['6074', '6100'],
        amount: EBN.from(6000 * 10 ** Moon.decimals), // Claim 2000 Moon
      }),
