...
import useMoonmageSiloBreakdown, { StateID, STATE_CONFIG } from '~/hooks/moonmage/useMoonmageBalancesBreakdown';
...
const MoonmageBalances: FC<{
  breakdown: ReturnType<typeof useMoonmageSiloBreakdown>;
}> = ({
  breakdown,
}) => {
  // Constants
...
export default MoonmageBalances;
