...
import useFertilizerYieldData from '~/hooks/moonmage/useFertilizerYieldData';
...
const copy = {
  fertilizedAmounts: '30-day exponential moving average of Fertilized Sprouts per Season. Fertilized Sprouts can be Rinsed to be redeemed for Moons.',
        ...
        <Row direction={{ xs: 'column', sm: 'row' }} alignItems="flex-start">
          <Box px={1} py={0.5} sx={{ maxWidth: SECTION_MAX_WIDTH }}>
            <Stat
              ...
              variant="h4"
              gap={0.25}
              amount={displayFullBN(yieldData.moonsPerSeasonEMA, 2)}
            />
          </Box>
          <Box px={1} py={0.5} sx={{ maxWidth: SECTION_MAX_WIDTH, alignSelf: 'center' }}>
            <Typography component="span">
              ...
              <Link
                underline="hover"
                href="https://docs.moon.money/almanac/guides/ship"
                target="_blank"
                rel="noreferrer"
