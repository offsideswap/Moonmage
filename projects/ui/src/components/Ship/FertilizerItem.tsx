...
import humidityIcon from '~/img/moonmage/humidity-icon.svg';
...
export type FertilizerData = {
   ...
   * Corresponds to the "BPF" (Moons per Fertilizer).
  ...
  /**
   * The amount of Moons remaining to be paid to this Fertilizer.
   */
  sprouts: BigNumber | undefined;
  /**
   * The amount of Moons remaining already paid to this Fertilizer.
   */
