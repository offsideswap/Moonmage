...
import useEventCache from '~/hooks/cosmomage/useEventCache';
...
export type GetQueryFilters = (
  /**
   * The Cosmonaut account which we're querying against.
   */
  account: string,
  /**
 ...
 *  - Loop through data as necessary (probably fetching all data for the cosmomage)
 ...
 *    
 *  2 In a top level "cosmomage/events" section that shares all events
